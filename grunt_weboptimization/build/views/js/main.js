...
function generator(a, b) {
    var c = getAdj(a), d = getNoun(b), e = parseInt(Math.random() * c.length), f = parseInt(Math.random() * d.length), g = "The " + c[e].capitalize() + " " + d[f].capitalize();
    return g;
}
...
function updatePositions() {
    ...
    for (var a = document.getElementsByClassName("mover"), b = a.length, c = [], d = 0; d < 5; d++) c[d] = Math.sin(document.body.scrollTop / 1250 + d);
    for (var d = 0; d < b; d++) {
        var e = c[d % 5];
        a[d].style.left = a[d].basicLeft + 100 * e + "px";
    }
...
var adjectives = [ "dark", "color", "whimsical", "shiny", "noisy", "apocalyptic", "insulting", "praise", "scientific" ], nouns = [ "animals", "everyday", "fantasy", "gross", "horror", "jewelry", "places", "scifi" ], selectRandomMeat = function() {
    ...
    var b, c, d, e, f, g;
    return b = document.createElement("div"), c = document.createElement("div"), d = document.createElement("img"), 
    e = document.createElement("div"), b.classList.add("randomPizzaContainer"), b.style.width = "33.33%", 
    b.style.height = "325px", b.id = "pizza" + a, c.style.width = "35%", d.src = "images/pizza.png", 
    d.classList.add("img-responsive"), c.appendChild(d), b.appendChild(c), e.style.width = "65%", 
    f = document.createElement("h4"), f.innerHTML = randomName(), e.appendChild(f), 
    g = document.createElement("ul"), g.innerHTML = makeRandomPizza(), e.appendChild(g), 
    b.appendChild(e), b;
    ...
    function c(a, b) {
        ...
        var d = a.offsetWidth, e = document.querySelector("#randomPizzas").offsetWidth, f = d / e, g = c(b), h = (g - f) * e;
        return h;
    }
    function d(a) {
        f = 0;
        for (var b = document.getElementsByClassName("randomPizzaContainer"), d = c(document.getElementsByClassName("randomPizzaContainer")[f], a), e = b[f].offsetWidth + d + "px", f = 0; f < b.length; f++) b[f].style.width = e;
    }
    window.performance.mark("mark_start_resize"), b(a), d(a), window.performance.mark("mark_end_resize"), 
...
window.addEventListener("scroll", function() {
    ...
    for (var a = 8, b = 256, c = 0; c < 35; c++) {
        var d = document.createElement("img");
        d.className = "mover", d.src = "images/pizza.png", d.style.height = "100px", d.style.width = "73.333px", 
        d.basicLeft = c % a * b, d.style.top = Math.floor(c / a) * b + "px", document.getElementById("movingPizzas1").appendChild(d);
    }
    updatePositions();
});